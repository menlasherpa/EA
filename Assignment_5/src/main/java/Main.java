...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        canGraduate.setLockMode(LockModeType.PESSIMISTIC_WRITE);
        ...
        Long id = student1.getStudentId();
        if(cache.contains(Distance.class, id )) {
            System.out.println("Student entity is cached!!");
        } else {
            System.out.println("Student entity is not cached :(");
        }
